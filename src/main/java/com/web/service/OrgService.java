...
//    }
    ...
    public void updateEmp() {
        ...
        //查询
            ...
            String ret2 = approvalService.getEmployeeUsers();
//            System.out.println(ret2);
            JSONObject jo2 = JSON.parseObject(ret2);
                JSONArray jsonArray = JSON.parseArray(jo2.getString("data"));
                for (int i = 0; i < jsonArray.size(); i++) {
...
//                    System.out.println(i+"----"+job.toJSONString());
                    Employee emp = new Employee();
                    emp.setYgbh(job.getString("UserName"));
                    emp.setZzdwbm(job.getString("DeptID"));
                    emp.setYgxm(job.getString("RealName"));
                    emp.setSjhm(job.getString("MobileTel"));
                    emp.setIsLockedOut(job.getString("IsLockedOut"));
