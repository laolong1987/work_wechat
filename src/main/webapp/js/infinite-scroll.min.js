...
!function (t, e) {
  ...
  var o = Array.prototype.slice, r = t.console,
  ...
  i.extend = function (t, e) {
    ...
    return t.forEach(function (t) {
      if (t instanceof HTMLElement) {
        ...
        e(t, n) && o.push(t);
        for (var i = t.querySelectorAll(n),
               r = 0; r < i.length; r++)o.push(i[r])
      }
    }), o
  ...
  return i.htmlInit = function (e, o) {
    i.docReady(function () {
      var r = i.toDashed(o), s = "data-" + r,
        l = document.querySelectorAll("[" + s + "]"),
        a = document.querySelectorAll(".js-" + r),
        h = i.makeArray(l).concat(i.makeArray(a)), u = s + "-options",
        c = t.jQuery;
  ...
  s.log = function (t, e) {
    ...
    var e = t.replace("{{#}}", "(\\d\\d?\\d?)"), i = new RegExp(e),
  ...
  function i(t) {
    for (var e = document.createDocumentFragment(),
           i = 0; t && i < t.length; i++)e.appendChild(t[i]);
    return e
  }
  ...
  return e.create.history = function () {
    ...
    for (var t, e, i = this.getScrollViewY(),
           n = 0; n < this.scrollPages.length; n++) {
